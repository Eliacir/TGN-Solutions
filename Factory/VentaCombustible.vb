...
Public Class VentasEnTurnoResultado
    Private _NumeroVentas As Int64

    Public Property NumeroVentas As Int64
        Get
    ...
    Private _PorcentajeFidelizacion As Double

    Public Property PorcentajeFidelizacion As Double
        Get
            Return _PorcentajeFidelizacion
        End Get
        Set(value As Double)
            _PorcentajeFidelizacion = value
        End Set
    End Property
End Class


Public Class ValidacionChip
    ...
    Private _TipoIdentificador As TipoValidacionChip
    Public Property TipoIdentificador() As TipoValidacionChip
        Get
            Return _TipoIdentificador
        End Get
        Set(ByVal value As TipoValidacionChip)
            _TipoIdentificador = value
        End Set
    End Property
