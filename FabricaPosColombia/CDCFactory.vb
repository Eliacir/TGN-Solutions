...
Public Class CondicionesComerciales
    Private _EsDescuentoCliente As Boolean
    Public Property EsDescuentoCliente() As Boolean
        Get
            Return _EsDescuentoCliente
        End Get
        Set(ByVal value As Boolean)
            _EsDescuentoCliente = value
        End Set
    End Property

    Private _EsPorPorcentaje As Boolean
    Public Property EsPorPorcentaje() As Boolean
        Get
            Return _EsPorPorcentaje
        End Get
        Set(ByVal value As Boolean)
            _EsPorPorcentaje = value
        End Set
    End Property

    Private _TieneDescuento As Boolean
    Public Property TieneDescuento() As Boolean
        Get
            Return _TieneDescuento
        End Get
        Set(ByVal value As Boolean)
            _TieneDescuento = value
        End Set
    End Property
    ...
    Public Property Slogan() As Double
        Get
            Return _Slogan
        End Get
        Set(ByVal value As Double)
    ...
    Private _PosicionSlogan As Boolean
    Public Property PosicionSlogan() As Boolean
        Get
            Return _PosicionSlogan
        End Get
        Set(ByVal value As Boolean)
            _PosicionSlogan = value
        End Set
    End Property

    Private _ValorSlogan As Double
    Public Property ValorSlogan() As Double
        Get
            Return _ValorSlogan
        End Get
        Set(ByVal value As Double)
